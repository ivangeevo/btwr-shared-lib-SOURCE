...
public class OGStackDroppingManager {

    private static final OGStackDroppingManager instance = new OGStackDroppingManager();
    ...
    private OGStackDroppingManager() {}

    public static OGStackDroppingManager getInstance() {
        return instance;
    }
