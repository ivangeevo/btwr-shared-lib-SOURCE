...
public class BTWRConventionalTags {
    ...
    public static class Blocks {
        ...
        /** Modded blocks that can convert to another state on break **/
         ...
         * <p>Mods should add their blocks to this tag if they want them to work with the
        ...
        /** Combining Tag for Web like blocks; Cobweb from vanilla and Web Block from Animageddon **/
        ...
        /**
         * Slab blocks that become "loose" when breaking a neighboring block.
         * <p>Initially used by Tough Environment's mechanic where grass and dirt blocks loosen neighboring blocks to their loose variants after broken
          */
        public static final TagKey<Block> LOOSEN_ON_IMPROPER_BREAK_SLABS = createTag("loosen_on_improper_break_slabs");

        /** Strata block tiers
         * <p>Mods should add their custom blocks to these tags to be considered valid for each strata
         **/
        ...
        /** Strata ore block tiers
         * <p>Mods should add their custom blocks to these tags to be considered valid for each strata
         **/
        public static final TagKey<Block> ORE_STRATA1 = createTag("ore_strata1");
    ...
    public static class Items {
         ...
         * <p> This tag only works in combination with the {@link BTWRConventionalTags.Items#CRAFTING_WITH_TOOLS_ITEMS} tag**/
         ...
         * <p>If you also want those tools to take damage on crafting then add them to the {@link BTWRConventionalTags.Items#DAMAGE_ON_CRAFTING_TOOLS} tag.
         */
